...
public class TodoList   {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "A list of things TODO for today", required = true, value = "")
  @NotNull
  ...
  public TodoList items(List<TodoListItem> items) {
    this.items = items;
    return this;
  }

  public TodoList addItemsItem(TodoListItem itemsItem) {
    if (this.items == null) {
